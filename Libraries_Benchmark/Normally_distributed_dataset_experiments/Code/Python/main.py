...
library_name = 'diffprivlib'    # libraries: 'diffprivlib', 'smartnoise', 'openmined_pydp'
dataset_folder_path = 'synthetic_datasets\\' # path to the dataset folder
number_of_csv_files = 27    # number of csv files in dataset folder
query = 'count'           # query could be = count, sum, mean, var (for smartnoise: variance)
