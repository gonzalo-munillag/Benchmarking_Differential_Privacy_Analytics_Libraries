...
for (i in 0:number_of_csv_file) {
  ...
  for (eps in epsilon){
        ...
        write.table(time.taken, paste0("~/publication/bigO/results/diffpriv/count_time_eps_",eps,"_dataset_",i,".csv"), append = T, row.names = F, col.names=F, eol = "\n") 
  }
} 
