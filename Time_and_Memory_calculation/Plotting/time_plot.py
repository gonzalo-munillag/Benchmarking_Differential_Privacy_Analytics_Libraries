...
result_folder = "path to micro folder"
query = 'var'
...
diffpriv_time_1 = pd.read_csv(result_folder + "\\diffpriv_simple_time\\{q}\\results_dataset_0\\execution_time.csv".format(q=query), header=None)
diffpriv_time_2 = pd.read_csv(result_folder + "\\diffpriv_simple_time\\{q}\\results_dataset_1\\execution_time.csv".format(q=query), header=None)
diffpriv_time_3 = pd.read_csv(result_folder + "\\diffpriv_simple_time\\{q}\\results_dataset_2\\execution_time.csv".format(q=query), header=None)
diffpriv_time_4 = pd.read_csv(result_folder + "\\diffpriv_simple_time\\{q}\\results_dataset_3\\execution_time.csv".format(q=query), header=None)
diffpriv_time_5 = pd.read_csv(result_folder + "\\diffpriv_simple_time\\{q}\\results_dataset_4\\execution_time.csv".format(q=query), header=None)
diffpriv_time_6 = pd.read_csv(result_folder + "\\diffpriv_simple_time\\{q}\\results_dataset_5\\execution_time.csv".format(q=query), header=None)
diffpriv_time_7 = pd.read_csv(result_folder + "\\diffpriv_simple_time\\{q}\\results_dataset_6\\execution_time.csv".format(q=query), header=None)


diffprivlib_time_1 = pd.read_csv(result_folder + "\\diffprivlib\\{q}\\results_dataset_0\\AVG_time.csv".format(q=query), header=None)
diffprivlib_time_2 = pd.read_csv(result_folder + "\\diffprivlib\\{q}\\results_dataset_1\\AVG_time.csv".format(q=query), header=None)
diffprivlib_time_3 = pd.read_csv(result_folder + "\\diffprivlib\\{q}\\results_dataset_2\\AVG_time.csv".format(q=query), header=None)
diffprivlib_time_4 = pd.read_csv(result_folder + "\\diffprivlib\\{q}\\results_dataset_3\\AVG_time.csv".format(q=query), header=None)
diffprivlib_time_5 = pd.read_csv(result_folder + "\\diffprivlib\\{q}\\results_dataset_4\\AVG_time.csv".format(q=query), header=None)
diffprivlib_time_6 = pd.read_csv(result_folder + "\\diffprivlib\\{q}\\results_dataset_5\\AVG_time.csv".format(q=query), header=None)
diffprivlib_time_7 = pd.read_csv(result_folder + "\\diffprivlib\\{q}\\results_dataset_6\\AVG_time.csv".format(q=query), header=None)


smartnoise_time_1 = pd.read_csv(result_folder + "\\smartnoise\\{q}\\results_dataset_0\\AVG_time.csv".format(q=query), header=None)
smartnoise_time_2 = pd.read_csv(result_folder + "\\smartnoise\\{q}\\results_dataset_1\\AVG_time.csv".format(q=query), header=None)
smartnoise_time_3 = pd.read_csv(result_folder + "\\smartnoise\\{q}\\results_dataset_2\\AVG_time.csv".format(q=query), header=None)
smartnoise_time_4 = pd.read_csv(result_folder + "\\smartnoise\\{q}\\results_dataset_3\\AVG_time.csv".format(q=query), header=None)
smartnoise_time_5 = pd.read_csv(result_folder + "\\smartnoise\\{q}\\results_dataset_4\\AVG_time.csv".format(q=query), header=None)
smartnoise_time_6 = pd.read_csv(result_folder + "\\smartnoise\\{q}\\results_dataset_5\\AVG_time.csv".format(q=query), header=None)
smartnoise_time_7 = pd.read_csv(result_folder + "\\smartnoise\\{q}\\results_dataset_6\\AVG_time.csv".format(q=query), header=None)


pydp_time_1 = pd.read_csv(result_folder + "\\pydp\\{q}\\results_dataset_0\\AVG_time.csv".format(q=query), header=None)
pydp_time_2 = pd.read_csv(result_folder + "\\pydp\\{q}\\results_dataset_1\\AVG_time.csv".format(q=query), header=None)
pydp_time_3 = pd.read_csv(result_folder + "\\pydp\\{q}\\results_dataset_2\\AVG_time.csv".format(q=query), header=None)
pydp_time_4 = pd.read_csv(result_folder + "\\pydp\\{q}\\results_dataset_3\\AVG_time.csv".format(q=query), header=None)
pydp_time_5 = pd.read_csv(result_folder + "\\pydp\\{q}\\results_dataset_4\\AVG_time.csv".format(q=query), header=None)
pydp_time_6 = pd.read_csv(result_folder + "\\pydp\\{q}\\results_dataset_5\\AVG_time.csv".format(q=query), header=None)
pydp_time_7 = pd.read_csv(result_folder + "\\pydp\\{q}\\results_dataset_6\\AVG_time.csv".format(q=query), header=None)
'''
chorus_time_1 = pd.read_csv(result_folder + "\\chorus_27April\\{q}\\results_dataset_0\\execution_time.csv".format(q=query), header=None)
chorus_time_2 = pd.read_csv(result_folder + "\\chorus_27April\\{q}\\results_dataset_1\\execution_time.csv".format(q=query), header=None)
chorus_time_3 = pd.read_csv(result_folder + "\\chorus_27April\\{q}\\results_dataset_2\\execution_time.csv".format(q=query), header=None)
chorus_time_4 = pd.read_csv(result_folder + "\\chorus_27April\\{q}\\results_dataset_3\\execution_time.csv".format(q=query), header=None)
chorus_time_5 = pd.read_csv(result_folder + "\\chorus_27April\\{q}\\results_dataset_4\\execution_time.csv".format(q=query), header=None)
chorus_time_6 = pd.read_csv(result_folder + "\\chorus_27April\\{q}\\results_dataset_5\\execution_time.csv".format(q=query), header=None)
chorus_time_7 = pd.read_csv(result_folder + "\\chorus_27April\\{q}\\results_dataset_6\\execution_time.csv".format(q=query), header=None)
'''
for i in range(3):
...
'''
chorus_eps1_list = [np.mean(chorus_1[0:5]),np.mean(chorus_2[0:5]),np.mean(chorus_3[0:5]),np.mean(chorus_4[0:5]),np.mean(chorus_5[0:5]),np.mean(chorus_6[0:5]),np.mean(chorus_7[0:5])]
chorus_eps2_list = [np.mean(chorus_1[5:10]),np.mean(chorus_2[5:10]),np.mean(chorus_3[5:10]),np.mean(chorus_4[5:10]),np.mean(chorus_5[5:10]),np.mean(chorus_6[5:10]),np.mean(chorus_7[5:10])]
chorus_eps3_list = [np.mean(chorus_1[10:15]),np.mean(chorus_2[10:15]),np.mean(chorus_3[10:15]),np.mean(chorus_4[10:15]),np.mean(chorus_5[10:15]),np.mean(chorus_6[10:15]),np.mean(chorus_7[10:15])]
'''
...
ax1.set_ylabel('𝔼[Execution Time] \n [s]', fontsize = 16)
